		...
		$this->start_controls_tab(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .name, {{WRAPPER}} .ova-team .content .item-team .info .name a' => 'color : {{VALUE}};'
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job' => 'color : {{VALUE}};',
					],
				]
			);
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .name:hover, {{WRAPPER}} .ova-team .content .item-team .info .name a:hover' => 'color : {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job:hover' => 'color : {{VALUE}};',
					],
				]
			);
				...
				$this->start_controls_tab(
                    ...
                    $this->add_control(
						...
						[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-team .content .item-team .list-icon ul .item' => 'background-color : {{VALUE}};',
							],
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .ova-team .content .item-team .list-icon ul .item:hover' => 'background-color : {{VALUE}};',
							],
						]
					);
		...
		$this->start_controls_section(
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job:before' => 'background-color : {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job:hover:before' => 'background-color : {{VALUE}};',
					],
				]
			);
            ...
            $this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job:before' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-team .content .item-team .info .job:before' => 'height: {{SIZE}}{{UNIT}};',
					],
				]
			);
