...
class Transflash_Elementor_Menu_Footer extends Widget_Base {

	
	public function get_name() {
		return 'transflash_elementor_menu_footer';
	}

	
	public function get_title() {
		return esc_html__( 'Menu Footer', 'transflash' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_menu',
			[
				'label' => esc_html__( 'Menu', 'transflash' ),
			]
		);
...
$widgets_manager->register( new Transflash_Elementor_Menu_Footer() );