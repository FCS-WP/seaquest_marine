...
class Transflash_Elementor_Progress extends Widget_Base {

	
	public function get_name() {
		return 'transflash_elementor_progress';
	}

	public function get_title() {
		return esc_html__( 'Progress', 'transflash' );
	}
	...
	public function get_script_depends() {
		...
		return [ 'transflash-elementor-progress' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_progress',
			[
				'label' => esc_html__( 'Progress', 'transflash' ),
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'placeholder' 	=> esc_html__( 'Enter your title', 'transflash' ),
					'default' 		=> esc_html__( 'My Skill', 'transflash' ),
					'label_block' 	=> true,
				]
			);
			...
			$this->add_control(
				'percent',
				[
					'label' 	=> esc_html__( 'Percent', 'transflash' ),
			...
			$this->add_control(
	            'show_percent',
	            [
	                'label' 	=> esc_html__( 'Show Percent', 'transflash' ),
	                'type' 		=> Controls_Manager::SWITCHER,
	                'default' 	=> 'yes',
	                'separator' => 'before',
	            ]
	        ...
	        $this->add_control(
	            'show_notes',
	            [
	                'label' 	=> esc_html__( 'Show Notes', 'transflash' ),
	                'type' 		=> Controls_Manager::SWITCHER,
	                'default' 	=> 'no',
	                'separator' => 'before',
	            ]
	        ...
	        $repeater->add_control(
	            'item_color',
	            [
	                'label' 	=> esc_html__( 'Item Color', 'transflash' ),
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' 	=> [
	                    [
	                        'item_text' 	=> esc_html__( 'Pre Sale', 'transflash' ),
	                    ],
	                    [
	                        'item_text' 	=> esc_html__( 'Soft Cap', 'transflash' ),
	                    ],
	                    [
	                        'item_text' 	=> esc_html__( 'Bonus', 'transflash' ),
	                    ],
	                ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progress Bar', 'transflash' ),
			...
			$this->add_control(
	            'title_alignment',
	            [
	                'label' 	=> esc_html__( 'Alignment List', 'transflash' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Linear Gradient', 'transflash' ),
					'type' 		=> Controls_Manager::COLOR,
				]
			);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Percentage', 'transflash' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			'section_note_style',
			[
				'label' => esc_html__( 'Notes', 'transflash' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$percent 			= isset( $settings['percent'] ) ? $settings['percent'] : '';
		$show_percent 		= isset( $settings['show_percent'] ) ? $settings['show_percent'] : '';
		$percent_bg 		= isset( $settings['percent_bg'] ) ?  $settings['percent_bg'] : '';
		$linear_gradient 	= isset( $settings['percent_linear_gradient'] ) ? $settings['percent_linear_gradient'] : '';
		$bg 				= '';
...
$widgets_manager->register( new Transflash_Elementor_Progress() );