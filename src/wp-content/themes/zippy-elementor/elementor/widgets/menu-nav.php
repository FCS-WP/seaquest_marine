...
class Transflash_Elementor_Menu_Nav extends Widget_Base {

	public function get_name() {
		return 'transflash_elementor_menu_nav';
	}

	public function get_title() {
		return esc_html__( 'Menu', 'transflash' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Parent Menu', 'transflash' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Menu', 'transflash' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Background Item Hover', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
	...
	protected function render() {
		...
		<nav class="main-navigation">
            <button class="menu-toggle">
            	<span>
            		<?php echo esc_html__( 'Menu', 'transflash' ); ?>
            	</span>
            </button>
			<?php
				@wp_nav_menu( [
...
$widgets_manager->register( new Transflash_Elementor_Menu_Nav() );
