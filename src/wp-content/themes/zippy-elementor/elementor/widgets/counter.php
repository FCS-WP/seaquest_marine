 ...
 * @since 1.0.0
 */
class Transflash_Elementor_Counter extends Widget_Counter {
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_counter',
			[
				'label' => esc_html__( 'Counter', 'transflash' ),
			]
		);
		...
		$this->add_control(
			'starting_number',
			[
				'label' => esc_html__( 'Starting Number', 'transflash' ),
		...
		$this->add_control(
			'ending_number',
			[
				'label' => esc_html__( 'Ending Number', 'transflash' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 100,
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			'prefix',
			[
				'label' => esc_html__( 'Number Prefix', 'transflash' ),
		...
		$this->add_control(
			'suffix',
			[
				'label' => esc_html__( 'Number Suffix', 'transflash' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => '',
				'placeholder' => esc_html__( 'Plus', 'transflash' ),
			]
		);
		...
		$this->add_control(
			'behind',
			[
				'label' => esc_html__( 'Number behind', 'transflash' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => false,
				],
				'default' => '',
				'placeholder' => esc_html__( '01', 'transflash' ),
			]
		);
		...
		$this->add_control(
			'duration',
			[
				'label' => esc_html__( 'Animation Duration', 'transflash' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 2000,
				'min' => 100,
				'step' => 100,
		...
		$this->add_control(
			'thousand_separator',
			[
				'label' => esc_html__( 'Thousand Separator', 'transflash' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Separator', 'transflash' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Cool Number', 'transflash' ),
				'placeholder' => esc_html__( 'Cool Number', 'transflash' ),
			]
		);
        ...
        $this->add_control(
			'column_layout',
			[
				'label' => esc_html__( 'Column Layout', 'transflash' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'label_on' => esc_html__( 'Show', 'transflash' ),
				'label_off' => esc_html__( 'Hide', 'transflash' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'ova_counter_half_border_right_normal',
                [
                    'label'     => esc_html__( 'Half Border Right Width', 'transflash' ),
                    ...
                    'selectors' => [
                        '{{WRAPPER}}.elementor-widget-counter .elementor-counter:after' => 'border-right-width: {{SIZE}}{{UNIT}}',
                    ],
                ]
            );
		...
		$this->start_controls_section(
			'section_number',
			[
				'label' => esc_html__( 'Number', 'transflash' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper .elementor-counter-number',
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'number_shadow',
				'selector' => '{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper',
			]
		);
    	...
    	$this->add_control(
			'underline_style',
			[
				'label' 	=> esc_html__( 'Underline Style', 'transflash' ),
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper .icon i' => 'color : {{VALUE}};',
					],
				]
		    );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper .icon:hover i' => 'color : {{VALUE}};',
					],
				]
			);    
			...
			$this->add_responsive_control(
                ...
                [
                    ...
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
                        '{{WRAPPER}}.elementor-widget-counter .elementor-counter .elementor-counter-number-wrapper .icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label' 	=> esc_html__( 'Behind', 'transflash' ),
                'tab'   	=> Controls_Manager::TAB_STYLE,
                'condition' => [
                	'behind!' => '',
                ],
	...
	protected function render() {
		...
		<div class="elementor-counter">
			...
			<div class="elementor-counter-number-wrapper <?php if( $settings['column_layout'] =="yes") echo "column";?>">
...
$widgets_manager->register(new Transflash_Elementor_Counter());
