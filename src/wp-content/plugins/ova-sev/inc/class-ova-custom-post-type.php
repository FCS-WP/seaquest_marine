	...
	class OVASEV_custom_post_type{
		...
		function OVASEV_register_post_type_ova_sev() {
			...
			$labels = array(
				...
				'add_new_item'          => __( 'Add New Service', 'ova-sev' ),
				'add_new'               => __( 'Add New Service', 'ova-sev' ),
			...
			$args = array(
				...
				'rewrite'             => array( 'slug' => _x( 'ova_sev', 'URL slug', 'ova-sev' ) ),
		...
		function OVASEV_register_taxonomy_ova_sev(){
			...
			$labels = array(
				...
				'menu_name'                  => __( 'Category Service', 'ova-sev' ),
