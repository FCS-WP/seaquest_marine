...
add_filter( 'transflash_header_customize', 'transflash_header_customize_team', 10, 1 );
function transflash_header_customize_team( $header ){
...
add_filter( 'transflash_header_bg_customize', 'transflash_header_bg_customize_team', 10, 1 );
function transflash_header_bg_customize_team( $bg ){
...
add_filter( 'transflash_footer_customize', 'transflash_footer_customize_team', 10, 1 );
function transflash_footer_customize_team( $footer ){
    
   if( is_tax( 'cat_team' ) ||  get_query_var( 'cat_team' ) != '' || is_post_type_archive( 'team' ) ){

        $footer = get_theme_mod( 'archive_footer_team', '' );

    }else if( is_singular( 'team' ) ){

        $footer = get_theme_mod( 'single_footer_team', '' );
    }
...
add_image_size( 'team_square', 300, 300, true );
add_image_size( 'team_small', 300, 250, true );
