 ...
 */
class Transflash_Google_Font_Select_Custom_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'ova-custom-controls', TRANSFLASH_URI . '/customize/assets/customizer.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_style( 'ova-custom-controls', TRANSFLASH_URI . '/customize/assets/customizer.css', array(), '1.1', 'all' );
	...
	public function render_content() {
		...
		if( !empty($this->fontList) ) {
			...
			<div class="google_fonts_select_control">
				...
				<div class="customize-control-description"><?php esc_html_e( 'Load Font Weight', 'transflash' ); ?></div>
	...
	public function ova_getGoogleFontsx( $count = 30 ) {
		...
		$fontFile = TRANSFLASH_URI . '/customize/custom-control/api/google-fonts-alphabetical.json';
		if ( $this->fontOrderBy === 'popular' ) {
			$fontFile = TRANSFLASH_URI . '/customize/custom-control/api/google-fonts-popularity.json' ;
		}
