...
if( !class_exists('Transflash_Metaboxes') ){
    
    class Transflash_Metaboxes {
        ...
        function add(){
            ...
            add_meta_box(
                ...
                apply_filters( 'transflash_set_header_version' ,array( 'post', 'page' ) )                  // Post type
            );
        ...
        function general_setting( $post ) {
            ...
            $list_header = apply_filters('transflash_list_header', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('transflash_list_header', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $list_footer = apply_filters('transflash_list_footer', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('transflash_list_footer', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $layouts = apply_filters('transflash_define_layout', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('transflash_define_layout', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $wide_site = apply_filters('transflash_define_wide_boxed', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('transflash_define_wide_boxed', '') ) : array( 'global' => 'Global' );
            ?>
...
return new Transflash_Metaboxes();
