...
add_filter( 'transflash_header_customize', 'transflash_header_customize_sev', 10, 1 );
function transflash_header_customize_sev( $header ){
...
add_filter( 'transflash_header_bg_customize', 'transflash_header_bg_customize_sev', 10, 1 );
function transflash_header_bg_customize_sev( $bg ){
...
add_filter( 'transflash_footer_customize', 'transflash_footer_customize_sev', 10, 1 );
function transflash_footer_customize_sev( $footer ){
    
   if( is_tax( 'cat_sev' ) ||  get_query_var( 'cat_sev' ) != '' || is_post_type_archive( 'ova_sev' ) ){

        $footer = get_theme_mod( 'archive_footer_sev', '' );

    }else if( is_singular( 'ova_sev' ) ){

        $footer = get_theme_mod( 'single_footer_sev', '' );
    }
