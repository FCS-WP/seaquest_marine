 ...
 * @since 1.0.0
 */
class Transflash_Elementor_Toggle extends Widget_Toggle {
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Toggle', 'transflash' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Title', 'transflash' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Toggle Content', 'transflash' ),
				'show_label' => false,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Toggle Items', 'transflash' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Toggle #1', 'transflash' ),
					...
					[
						'tab_title' => esc_html__( 'Toggle #2', 'transflash' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'transflash' ),
					],
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Icon', 'transflash' ),
				'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'transflash' ),
		...
		$this->add_control(
			'faq_schema',
			[
				'label' => esc_html__( 'FAQ Schema', 'transflash' ),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__( 'Space Between', 'transflash' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius Active', 'transflash' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_control(
				'show_before_title',
				[
					'label' 	=> esc_html__( 'Show Before Title', 'transflash' ),
            ...
            $this->add_control(
                'ova_before_title',
                [
                    'label'     => esc_html__( 'Before Title Style', 'transflash' ),
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label' => esc_html__( 'Hover Color', 'transflash' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'icon_active_color',
			[
				'label' => esc_html__( 'Active Color', 'transflash' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'icon_space',
			[
				'label' => esc_html__( 'Spacing', 'transflash' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
        ...
        $this->add_control(
				'show_boxes_icon',
				[
					'label' 	=> esc_html__( 'Show Border Icon', 'transflash' ),
					'type' 		=> \Elementor\Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'transflash' ),
					'label_off' => esc_html__( 'Hide', 'transflash' ),
					'default' 	=> 'no',
		...
		$this->add_control(
			'ova_before_icon',
			[
				'label' 	=> esc_html__( 'Before Icon', 'transflash' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin (p, h1... h6)', 'transflash' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
...
$widgets_manager->register(new Transflash_Elementor_Toggle());
