...
use ova_career_elementor\widgets\ova_hot_career;
use ova_career_elementor\widgets\ova_career_list_file;
...
class Ova_Career_Register_Elementor {
	...
	private function includes() {
		...
		require OVACAREER_PLUGIN_PATH . 'elementor/widgets/ova_hot_career.php';
	...
	private function register_widget() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new ova_hot_career() );
