 ...
 * @since 1.0.0
 */
class Transflash_Elementor_Header_Banner extends Widget_Base {
	...
	public function get_name() {
		return 'transflash_elementor_header_banner';
	}
	...
	public function get_title() {
		return esc_html__( 'Header Banner', 'transflash' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label'        => esc_html__( 'Display Boxed Content', 'transflash' ),
			...
			$this->add_control(
				'header_bg_source',
				[
					'label'        => esc_html__( 'Display Background by Feature Image in Post/Page', 'transflash' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'no'
				]
			);
			...
			$this->add_control(
				'cover_color',
				[
					'label' => esc_html__( 'Background Cover Color', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => 'rgba(0,0,0,0.51)',
					'description' => esc_html__( 'You can add background image in Advanced Tab', 'transflash' ),
					'selectors' => [
			...
			$this->add_control(
				'title_color',
				[
					'label' => esc_html__( 'Title Color', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_responsive_control(
				'title_padding',
				[
					'label' => esc_html__( 'Title Padding', 'transflash' ),
			...
			$this->add_control(
				'title_tag',
				[
					'label' => esc_html__( 'Choose Title Format', 'transflash' ),
			...
			$this->add_group_control(
				...
				[
					'name' => 'header_title',
					'label' => esc_html__( 'Title Typo', 'transflash' ),
					'selector'	=> '{{WRAPPER}} .header_banner_el .header_title',
				]
			);
			...
			$this->add_control(
				'show_breadcrumbs',
				[
					'label'        => esc_html__( 'Show Breadcrumbs', 'transflash' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'yes',
			...
			$this->add_control(
				'breadcrumbs_color',
				[
					'label' => esc_html__( 'Breadcrumbs Color', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Breadcrumbs Color hover', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Breadcrumbs Typography', 'transflash' ),
			...
			$this->add_responsive_control(
				'breadcrumbs_padding',
				[
					'label' => esc_html__( 'Breadcrumbs Padding', 'transflash' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
			...
			$this->add_control(
				'class',
				[
					'label' => esc_html__( 'Class', 'transflash' ),
		 		...
		 		<?php if( $settings['header_boxed_content'] == 'yes' ){ ?><div class="row_site"><div class="container_site"><?php } ?>
					...
					<div class="header_banner_el <?php echo esc_attr( $settings['class'] ); ?>">
						...
						<?php if( $settings['show_title'] == 'yes' ){ ?>
							...
							<?php add_filter( 'transflash_show_singular_title', '__return_false' ); ?>
...
$widgets_manager->register( new Transflash_Elementor_Header_Banner() );