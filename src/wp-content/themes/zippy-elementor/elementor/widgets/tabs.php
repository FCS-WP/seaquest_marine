 ...
 * @since 1.0.0
 */
class Transflash_Elementor_Tabs extends Widget_Tabs {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'tab_icon_image',
            [
                'label' => esc_html__( 'Icon/Image', 'transflash' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'transflash' ),
                        'icon' => 'eicon-ban',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'transflash' ),
                        'icon' => 'eicon-caret-right',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'transflash' ),
                        'icon' => 'eicon-image',
                    ],
                ],
                'default'   => 'none',
        ...
        $repeater->add_control(
            'ova_icon',
            [
                'label'     => esc_html__( 'Choose Icon', 'transflash' ),
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label' => esc_html__( 'Title & Description', 'transflash' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Tab Title', 'transflash' ),
                'placeholder' => esc_html__( 'Tab Title', 'transflash' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'transflash' ),
                'placeholder' => esc_html__( 'Tab Content', 'transflash' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'transflash' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'transflash' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'transflash' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'transflash' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'transflash' ),
                    ],
                ],
        ...
        $this->add_control(
            'view',
            [
                'label' => esc_html__( 'View', 'transflash' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'transflash' ),
                    'vertical' => esc_html__( 'Vertical', 'transflash' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '' => [
                        'title' => esc_html__( 'Start', 'transflash' ),
                    ...
                    'end' => [
                        'title' => esc_html__( 'End', 'transflash' ),
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => esc_html__( 'Navigation Width', 'transflash' ),
        ...
        $this->add_control(
            'border_width',
            [
                'label' => esc_html__( 'Border Width', 'transflash' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 1,
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'transflash' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        'flex' => [
                            'title' => esc_html__( 'Flex', 'transflash' ),
                            'icon' => 'eicon-h-align-left',
                        ],
                        'block' => [
                            'title' => esc_html__( 'Block', 'transflash' ),
                            'icon' => 'eicon-h-align-stretch',
                        ],
                        'none' => [
                            'title' => esc_html__( 'None', 'transflash' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}}.elementor-widget-tabs.elementor-tabs-view-vertical .elementor-tabs-wrapper' => 'width: {{SIZE}}{{UNIT}}',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'transflash' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'transflash' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => esc_html__( 'Active', 'transflash' ),
                    ]
                );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Border Color Active', 'transflash' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'ova_title_border_width_active',
                [
                    'label'         => esc_html__( 'Border Width Active', 'transflash' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-wrapper > .elementor-tab-desktop-title.elementor-active' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title.elementor-active' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'transflash' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'transflash' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
...
$widgets_manager->register(new Transflash_Elementor_Tabs());