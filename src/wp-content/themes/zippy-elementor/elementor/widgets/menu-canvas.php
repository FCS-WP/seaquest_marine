...
class Transflash_Elementor_Canvas_Menu extends Widget_Base {

	public function get_name() {
		return 'transflash_elementor_menu_canvas';
	}

	public function get_title() {
		return esc_html__( 'Menu Canvas', 'transflash' );
	}
	...
	public function get_script_depends() {
		return [ 'transflash-elementor-menu-canvas' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_menu_type',
			[
				'label' => esc_html__( 'Global', 'transflash' ),
			]
		);
			...
			$this->add_control(
				'menu_slug',
				[
					'label' => esc_html__( 'Select Menu', 'transflash' ),
			...
			$this->add_control(
				'menu_dir',
				[
					'label' => esc_html__( 'Menu Direction', 'transflash' ),
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Style', 'transflash' ),
			]
		);
			...
			$this->add_control(
				'bg_color',
				[
					'label' => esc_html__( 'Menu Background', 'transflash' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
			...
			$this->start_controls_tabs(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'text_color',
						[
							'label' => esc_html__( 'Menu Color', 'transflash' ),
							'type' => Controls_Manager::COLOR,
							'default' => '',
							'selectors' => [
...
$widgets_manager->register( new Transflash_Elementor_Canvas_Menu() );
