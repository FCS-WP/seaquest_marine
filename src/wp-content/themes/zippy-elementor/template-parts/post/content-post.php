...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-wrap '. $sticky_class); ?>  >
		...
		<?php if( ( has_post_format('audio') || has_post_format('gallery') || has_post_format('video' ) || has_post_thumbnail() ) && transflash_post_show_media() == 'yes' ): ?>	
		...
		<?php if( transflash_post_show_title() == 'yes' ){
		...
		<?php if(has_tag() &&  transflash_post_show_tag() == 'yes' ){ ?>
			<div class="post-tags">
